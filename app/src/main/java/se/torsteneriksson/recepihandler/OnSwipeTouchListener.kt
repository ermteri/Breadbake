...
Usage:
        ...
        instruction_tv?.setOnTouchListener(object : OnSwipeTouchListener(mActivity) {
            ...
            override fun onSwipeUp() {
                super.onSwipeUp()
                Toast.makeText(mActivity, "Swipe up gesture detected", Toast.LENGTH_SHORT)
                    .show()
            }
            override fun onSwipeDown() {
                super.onSwipeDown()
                Toast.makeText(mActivity, "Swipe down gesture detected", Toast.LENGTH_SHORT)
                    .show()
            }
        }
        )
